								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											<img src="{{ (!empty($adminData->photo)) ? url('upload/admin_images/'.$adminData->photo) : url('upload/user_null.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-dark" width="110">
											<div class="mt-3">
								...
								<div class="card">
                                    ...
                                    <div class="row mb-3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input name="name" type="text" class="form-control" value=" {{ $adminData->name}}" />
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
											...
											<img id="showImage" src="{{ (!empty($adminData->photo)) ? url('upload/admin_images/'.$adminData->photo)
                                             : url('upload/user_null.jpg')}}" alt="Admin" style ="width:100px; hieght:100px">
											</div>
                                            </div>
