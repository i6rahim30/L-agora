...
@php
	...
	$month = date('F');
	$months = App\Models\Order::where('order_month', $month)->sum('amount');
	$year = date('Y');
	$years = App\Models\Order::where('order_year', $year)->sum('amount');

	$pendings = App\Models\Order::where('status','pending')->get();

	$vendor = App\Models\User::where('status','active')->where('role','vendor')->get();
	$pvendor = App\Models\User::where('status','inactive')->where('role','vendor')->get();
	$customer = App\Models\User::where('status','active')->where('role','user')->get();
	$requsts = App\Models\Order::where('return_order',1)->get();
					...
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
						...
						<div class="col">
							<div class="card radius-10 bg-secondary bg-gradient">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{count($pvendor)}} Vendors</h5>
									<div class="ms-auto">
										<i class='fa-sharp fa-solid fa-coins fs-3 text-white'></i>
									</div>
								</div>
								...
								<div class="d-flex align-items-center text-white">
									<p class="mb-0">Pending Vendors</p>
						...
						<div class="col">
							<div class="card radius-10 bg-dark bg-gradient">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{count($customer)}} Users</h5>
									<div class="ms-auto">
										<i class='fa-sharp fa-solid fa-coins fs-3 text-white'></i>
									</div>
								</div>
						...
						<div class="col">
							<div class="card radius-10 bg-secondary bg-gradient">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{count($requsts)}} Requests</h5>
									<div class="ms-auto">
										<i class='fa-sharp fa-solid fa-coins fs-3 text-white'></i>
									</div>
								</div>
								...
								<div class="d-flex align-items-center text-white">
									<p class="mb-0">Return Requests</p>
