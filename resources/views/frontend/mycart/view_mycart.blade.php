...
<div class="page-header breadcrumb-wrap">
        ...
        <div class="container mb-80 mt-50">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive shopping-summery" style="border-radius: 17px;" >
                        <table class="table table-wishlist" >
                            <thead>
                                <tr class="main-heading" style="border-radius: 20px;">
                    ...
                    <div class="row mt-50">
                        ...
                        @if (Session::has('coupon'))
                            <div class="p-40">
                                <h3 class="mb-10">Apply Coupon</h3>
                                <p class="mb-30"><span class="font-lg">You Already Used A Coupon</p>
                            </div>
                        @else
