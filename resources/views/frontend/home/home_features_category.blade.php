                    ...
                    <div class="carausel-10-columns" id="carausel-10-columns">
                        ...
                        <div class="card-2 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="{{url('product/category/'.$category->id.'/'.$category->category_slug)}}"><img src="{{ asset($category->category_image) }}" alt="" style="width:70px;height:60px;"/></a>
                            </figure>
