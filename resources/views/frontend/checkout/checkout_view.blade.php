...
@csrf
    ...
    <div class="row">
        <div class="form-group col-lg-6">
            <input type="text" required="" name="shipping_name"  placeholder="Username" value="{{Auth::user()->name}}">
        </div>
        <div class="form-group col-lg-6">
            <input type="email" required="" name="shipping_email" placeholder="E-Mail" value="{{Auth::user()->email}}">
        </div>
    </div>
            ...
            <div class="row shipping_calculator">
                <div class="form-group col-lg-6">
                    <div class="custom_select">
                        <select required="" name="division_id" class="form-control select-active" >
            ...
            <div class="row shipping_calculator">
                <div class="form-group col-lg-6">
                    <div class="custom_select">
                        <select  required="" name="state_id"class="form-control select-active">
...
<table class="table no-border">
    <tbody>
        ...
        <tr>
            <td class="image product-thumbnail"><img src="{{asset($item->options->image)}}" style="width:50px;height:50px"></td>
            <td>
            ...
            <td>
                <h5 class="text-brand">{{$item->price}} LYD</h5>
            </td>
        </tr>
        @endforeach
    </tbody>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="cart_total_amount">
                <h4 class="text-brand text-end">{{$cartTotal}} LYD</h4>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="cart_total_amount">
                <h4 class="text-brand text-end">{{Session::get('coupon')['discount_amount']}} LYD </h4>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="cart_total_amount">
                <h4 class="text-brand text-end">{{Session::get('coupon')['total_amount']}} LYD</h4>
            </td>
        </tr>
        @else<tr>
            <td class="cart_total_label">
