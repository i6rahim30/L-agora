...
<div class="col-md-3">
    <div class="dashboard-menu">
        <ul class="nav flex-column" role="tablist" id="myTab">
            ...
            <li class="nav-item">
                <a class="nav-link {{($route == '')? 'active' : ''}}"href="#address"><i class="fi-rs-marker mr-10"></i>My Address</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item" style="background:#272424;">
                <a class="nav-link" href="{{ route('user.logout')}}" style="color:#ddd"><i class="fi-rs-sign-out mr-10"  style="color:#ddd"></i>Logout</a>
            </li>
        </ul>
    </div>
</div>