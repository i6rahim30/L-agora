                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                <h3 class="title-detail"><h3 class="text-heading" id="pname"></h3></h3><br>
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand" id="pprice" style="font-size:30px;">LYD</span>
                                        <span>
                                            <span class="old-price font-sm ml-15" id="oldprice" style="font-size:30px;">LYD</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="detail-extralink mb-30">
                                    ...
                                    <div class="product-extra-link2">
                                        ...
                                        <button type="submit" class="button button-add-to-cart" onclick="addToCart()" id="addToCartButton"><i class="fi-rs-shopping-cart" ></i>Add to cart</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
