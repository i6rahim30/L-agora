                                    ...
                                    <form method="post" action="{{ route('vendor.update.password')}}" >
										...
										<div class="row mb-3">
											...
											<div class="col-sm-5 text-secondary">
												<input type="password" name="old_password" class="form-control  @error('old_password') is-invalid @enderror" placeholder="Old Password" id="current_password" />
                                                @error('old_password')
										...
										<div class="row mb-3">
											...
											<div class="col-sm-5 text-secondary">
												<input type="password" name="new_password_confirmation" class="form-control" placeholder="Confirm New Password" id="new_password_confirmation" />
                                            </div>
										</div>
										<div class="row">
