                 ...
                 <input type="hidden" name="old_img" value="{{$products->product_thumbnail}}">
							...
							<div class="row card-body">
								<div class="mb-3">
									...
									<input name="product_thumbnail" class="form-control" type="file" id="image">
								</div>
						    </div>
...
<div class="page-content col-8">
            ...
            <table class="table">
                ...
                @foreach($multiImgs as $key => $img)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="file" class="form-control" name="multi_imgs[{{ $img->id }}]">
                                </td>                           
                                <td class="align-middle">
                                <input type="submit" class="btn btn-success" value="Save" />
                                <a href="{{ route('product.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete"> Delete </a> </td>
                            </tr>
                @endforeach
                ...
                <form method="post" action="{{route('add.multiimage')}}" enctype="multipart/form-data">
                @csrf 
                <input type="hidden" name="id" value="{{$products->id}}">
                    <div class="form-group mb-3">
