					...
					<div class="main-body">
						<div class="row">
							<div class="col-lg-10">
								<div class="card">
									<div class="card-body">
                                    <form method="post" action="{{ route('update.category')}}" enctype="multipart/form-data" id="myForm">
                                        @csrf 
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
											<img id="showImage" src="{{asset($category->category_image)}}" alt="Admin" style ="width:100px; hieght:100px">
											</div>
                                            </div>
