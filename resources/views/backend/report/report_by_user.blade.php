...
<div class="page-content">
				...
				<!--end breadcrumb-->
				<hr/>
                <div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <label class="form-label">Select user:</label>
                                        <select class="form-select select-active mb-3" aria-label="Default select example" name="user">
