...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Assign Permissions to Roles</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Assign Permissions to Role</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
					...
					<div class="main-body">
						<div class="row">
							<div class="col-lg-10">
								<div class="card">
									<div class="card-body">
                                    <form method="post" action="{{ route('role.permission.store')}}" id="myForm">
                                        @csrf 
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="flexCheckDefaultAll">All Access</label>
                                        </div>
                            ...
                            @endforeach
										...
										<div class="row">
											...
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary bg-gradiant px-4" value="Add New Role" />
											</div>
										</div>
									</div>
                                    </form>
