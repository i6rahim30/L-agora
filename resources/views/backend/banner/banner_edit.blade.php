					...
					<div class="main-body">
						<div class="row">
							<div class="col-lg-10">
								<div class="card">
									<div class="card-body">
                                    <form method="post" action="{{ route('update.banner')}}" enctype="multipart/form-data" id="myForm">
                                        @csrf 


                                   <input type="hidden" name="id" value="{{$banner->id}}"></input>
                                   <input type="hidden" name="old_img" value="{{$banner->banner_image}}"></input>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="file" name="banner_image" class="form-control" id="image" required/>
											</div>
                                            </div>
											...
											<div class="col-sm-9 text-secondary">
											<img id="showImage" src="{{asset($banner->banner_image)}}" alt="Admin" style ="width:100px; hieght:100px">
											</div>
                                            </div>
