					...
					<div class="main-body">
						<div class="row">
							<div class="col-lg-10">
								<div class="card">
									<div class="card-body">
                                    <form method="post" action="{{ route('store.banner')}}" enctype="multipart/form-data" id="myForm">
                                        @csrf 
										...
										<div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<input name="banner_title" type="text" class="form-control" value="" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<input name="banner_url" type="text" class="form-control" value="" />
											</div>
										</div>
